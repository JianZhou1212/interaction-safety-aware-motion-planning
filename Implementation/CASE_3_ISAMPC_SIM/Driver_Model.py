...
class Driver_Model( ): # The model for SV4, controlled by a stochastic linear state-feedback controller
    ...
    def Final_Return(self, k, X_State_LC, K_Lon, K_Lat): # Return com. results
        H = self.H
        N = self.N
