...
class Initialization_SV( ):
    ...
    def Initialize_MU_M_P(self, X_State): # state fusion steps of IMM-KF & define the primary reference speed
        N_M = self.N_M
        N = self.N
        N_Car = self.N_Car
        H = self.H
        ...
        p_m = np.diag(np.array([1, 1, 1, 1, 1, 1]))*1e-6#np.zeros((DTV, DTV)) # level 4
        p_0 = list( ) # level 3
        P_0 = list( ) # level 2
        ...
        for i in range(N_Car):
            if (i == 0) or (i == 4): # vehicle 0 and 4
            ...
            elif (i == 1) or (i == 2) or (i == 3) or (i == 6): # vehicle 1 and 6
                ...
                X_Hat_0.append(x_hat_0) # level 2
                P_0.append(p_0) # level 2
                ref_all_0 = [None, None, x_hat_m[1], x_hat_m[1], x_hat_m[1], None, None] # level 3
                REF_Speed_0.append(ref_all_0[m_0])
                ...
                X_Hat_0.append(x_hat_0) # level 2
                P_0.append(p_0) # level 2
                ref_all_0 = [None, None, None, None, None, x_hat_m[1], x_hat_m[1]] # level 3
                REF_Speed_0.append(ref_all_0[m_0])
