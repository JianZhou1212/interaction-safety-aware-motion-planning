...
class IAIMM_KF_MPC( ):
    ...
    def GMMObstacleRealization(self, Obst_k, MU_k, X_Po_All_k, X_Var_k, Y_Var_k, x_EV_k):
        ...
        Input: 
                   ...
                   MU_k is a list with probabilities of all maneuvers of SVs
                   X_Po_All_k is a list with all possible trajectories
        Output: 
    ...
    def Final_Return(self, k, state_k_loc, state_k_glo, Obst_k, y_k, X_Po_All_k, MU_k, X_Var_k, Y_Var_k):
        Ts = self.Ts
        N = self.N
        N_M_EV = self.N_M_EV
        N_Lane = self.N_Lane
    ...
    def Final_Return_Com_Time(self, k, state_k_loc, state_k_glo, Obst_k, y_k, X_Po_All_k, MU_k, X_Var_k, Y_Var_k):
        Ts = self.Ts
        N = self.N
        N_M_EV = self.N_M_EV
        N_Lane = self.N_Lane
